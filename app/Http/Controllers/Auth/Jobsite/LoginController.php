...
namespace App\Http\Controllers\Auth\Jobsite;
...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        return view('Jobsite.Auth.login');
    }
    ...
    {
        return view('Jobsite.Auth.Employeer-login');
    }
    ...
    {
        return view('Jobsite.Auth.candidate-login');
    }
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        if (Auth::user()->hasRole('Employer') && $type == Company::COMPANY_LOGIN_TYPE) {
            ...
            if (Auth::user()->hasRole('Candidate') && $type == Candidate::CANDIDATE_LOGIN_TYPE) {
                ...
                Auth::logout();
                $section = ($type == Company::COMPANY_LOGIN_TYPE) ? 'Employeer' : 'candidate-login';
